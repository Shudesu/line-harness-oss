...
CREATE INDEX IF NOT EXISTS idx_messages_log_dedup ON messages_log (friend_id, content_hash, created_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_messages_log_idempotency_key
