  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Banner tone="info" title="📌 使い方" className="mb-4">
        ...
        {loading ? (
          <Card>
            <CardContent className="pt-5 text-sm text-gray-500">読み込み中…</CardContent>
          </Card>
        ) : items.length === 0 ? (
          <EmptyState
            title="商品はまだありません"
            description="「＋ 新規追加」で登録してください。"
          />
        ) : (
              ...
              <CardContent className="pt-5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      <Label>Stripe Product ID (任意)</Label>
                      <Input
                        type="text"
                  ...
                  <div className="border-t border-gray-200 pt-3">
                    ...
                    <div className="space-y-2">
                      <div>
                        <Label className="text-xs text-gray-500 font-normal">付与するタグ</Label>
                        <Select
                          value={onTagId}
                      ...
                      <div>
                        <Label className="text-xs text-gray-500 font-normal">起動するシナリオ</Label>
                        <Select
                          value={onScenarioId}
                      ...
                      <div>
                        <Label className="text-xs text-gray-500 font-normal">送信するテンプレ</Label>
                        <Select
                          value={onTemplateId}
